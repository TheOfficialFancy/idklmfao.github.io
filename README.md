...
<body>
    <h1>Securly Destroyer (Newest Breaker By Junhao Lmfao)</h1>
    <div id="error"></div>
    <div id="draggable" draggable="true">Drag this Black Bar into your Website bat then enter.</div>
</body>
...
<head>
    ...
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>SecurlyBreaker 4.5.3</title>
    <style>
        #error {
            display: none;
        }
